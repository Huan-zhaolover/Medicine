...
@interface SVWebViewController () <UIWebViewDelegate,dataBaseDelegate>
...
- (void)viewDidLoad {
    ...
    [dataHandeler sharedataBase].delegate=self;
    
    self.navigationItem.rightBarButtonItem=[[UIBarButtonItem alloc ]initWithTitle:@"收藏" style:UIBarButtonItemStyleDone target:self action:@selector(save:)];
}

-(void)save:(UIBarButtonItem *)bubu{

    NSLog(@"%@",self.navigationItem.title);
    
    NSLog(@"%@,%@,%@",self.ccurl,self.cctableName,self.cctitle);
    
    [[dataHandeler sharedataBase]saveModelWithname:self.cctableName andtitle:self.cctitle andUrl:self.ccurl];
}

-(void)tishi{
    UIAlertController *altercontroller=[UIAlertController alertControllerWithTitle:@"提示" message:@"已经收藏" preferredStyle:UIAlertControllerStyleAlert];
